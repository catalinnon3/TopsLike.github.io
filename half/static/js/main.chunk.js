(window.webpackJsonpdeathdate = window.webpackJsonpdeathdate || []).push([
    [0], {
                ...
                Q = function(e) {
                    ...
                    return Object(x.a)(t, e), Object(d.a)(t, [{
                            ...
                            var e = Object(p.a)(u.a.mark((function e(t) {
                                ...
                                return u.a.wrap((function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        case 0:
                                            if (a = [
                                            	"Ваша настоящая любовь будет считать вас своим идеалом и выполнять любую вашу прихоть ❤",
                                                "Ваша настоящая любовь сделает все возможное , чтобы прожить с вами всю свою жизнь ❤",
                                                "Тебя ждет несчастная любовь и скорое расставание, которое приведет тебя к настоящей любви ❤",
                                                "Тебя ждет романтика и гармония в отношениях, ведь твоя вторая половинка будет готова достать для тебя звезду с неба❤",
                                                "Тебя ждет безответная любовь, легкомысленная и безрачличная со стороны этого человека 💔",
                                                "Тебе придется держать все под контролем, иногда манипулируя своей второй половинкой, чтобы прожить с ней до конца жизни ❤",
                                                "Любовь найдет тебя неожиданно и между вами вспыхнут страстные чувства ❤",
                                                "Это любовь не будет счатливой, все может закончится любовным треугольником 💔",
                                                "Ваша настоящая любовь будет считать вас своим идеалом и выполнять любую вашу прихоть ❤",
                                                "Ваша настоящая любовь сделает все возможное , чтобы прожить с вами всю свою жизнь ❤",
                                                "Тебя ждет несчастная любовь и скорое расставание, которое приведет тебя к настоящей любви ❤",
                                                "Тебя ждет романтика и гармония в отношениях, ведь твоя вторая половинка будет готова достать для тебя звезду с неба❤",
                        ...
                        value: function() {
                            ...
                            }, "❤ " + (this.state.paralel ? this.state._______reason2 : this.state.reason)), r.a.createElement("br", null), r.a.createElement(b.b, {
        ...
        95: function(e, t, a) {
            e.exports = a.p + "static/media/story-bg.fjj237fgg.png" /* тут хз что */
        },
        96: function(e, t, a) {
            e.exports = a.p + "static/media/story-bg.3dfg345g.png"
        },
        97: function(e, t, a) {
            e.exports = a.p + "static/media/story-bg.sd345hfgh5.png"
        },
        98: function(e, t, a) {
            e.exports = a.p + "static/media/story-bg.452hdfsfg34.png"
        },
        99: function(e, t, a) {
            e.exports = a.p + "static/media/story-bg.sdf3254g.png" /* тут хз что */
        }
    },
    [
        [167, 1, 2]
